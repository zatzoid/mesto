...
/* CARD ADDER */
/* функция коздания карточки, принимает объект со свойствами, и создает элемент с изображением и кнопками */
...
/* save form add */
/* принимает значение инпутов сэйва и передает их в свойства объекта */
